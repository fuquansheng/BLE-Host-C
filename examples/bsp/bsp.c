...
#define ADVERTISING_DIRECTED_LED_ON_INTERVAL   500
#define ADVERTISING_DIRECTED_LED_OFF_INTERVAL  500

#define ADVERTISING_WHITELIST_LED_ON_INTERVAL  500
#define ADVERTISING_WHITELIST_LED_OFF_INTERVAL 500

#define ADVERTISING_SLOW_LED_ON_INTERVAL       500
#define ADVERTISING_SLOW_LED_OFF_INTERVAL      500

#define BONDING_INTERVAL                       500

#define SENT_OK_INTERVAL                       500
#define SEND_ERROR_INTERVAL                    500

#define RCV_OK_INTERVAL                        500
